// Adapted from from: https://github.com/eth-infinitism/account-abstraction/blob/develop/src/Create2Factory.ts
// Which uses from: https://github.com/Arachnid/deterministic-deployment-proxy
import { BigNumber, BigNumberish, ethers, Signer, utils, Wallet } from "ethers";
...
export class Create2Factory {
  ...
  constructor(readonly provider: Provider, readonly signer: Wallet) {}
  ...
  async deploy(
    ...
    console.log("Deploying to addr " + addr);
